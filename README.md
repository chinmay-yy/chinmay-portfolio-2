# Chinmay Saini | Developer Portfolio

A dark-themed, single-page 3D  portfolio built with React, TypeScript, Tailwind CSS, and Framer Motion.

vercel link - https://chinmay-portfolio-new.vercel.app/
...
```bash
git clone https://github.com/chinmay-yy/chinmay-portfolio.git
```
